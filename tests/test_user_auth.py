...
class TestUserAuth(BaseCase):
    ...
    def setup(self): # выполняется каждый раз в самом начале перед всеми тестами
        data = {
        ...
        self.user_id_from_method = self.get_json_value(response1, "user_id")
    ...
    def test_auth_user(self):
        ...
        Assertions.assert_json_value_by_name(response2, "user_id", self.user_id_from_method, "User id is not equal")
